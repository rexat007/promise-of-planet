import { runAdminModalViewportTests } from '../src/services/adminModalViewportTests';

async function main() {
  console.log('====================================================');
  console.log('RUNNING ADMIN MODAL VIEWPORT FOUNDATION TESTS');
  console.log('====================================================\n');

  const results = await runAdminModalViewportTests();
  let passedCount = 0;
  let failedCount = 0;
